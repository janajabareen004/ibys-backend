...
class ImageService:
    """Business logic and Supabase access for the images resource.
    ...
    def update(self, image_id, data):
        ...
        # image_id and project_id must never be updated from the body.
        Image.strip_protected(data)
